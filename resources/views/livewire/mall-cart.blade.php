                            ...
                            @foreach ($cartItems as $item)
                                <tr>
                                    ...
                                    <td class="product-price-cart"><span
                                            class="amount">XAF {{ number_format(\Cart::session(auth()->id())->get($item['id'])->getPriceSum()) }}</span>
                                    </td>
                    ...
                    <div class="row">
                        <div class="col-md-5 ml-auto">
                            <div class="cart-page-total">
                                <h2>Cart totals</h2>
                                <ul>
                                    <li>SubTotal<span>{{ number_format(\Cart::session(auth()->id())->getSubTotal()) }}</span></li>
                                    <li>Total<span>{{ number_format(\Cart::session(auth()->id())->getTotal()) }}</span></li>
                                </ul>
